...
public class WeatherController extends AMachine implements RecipeDisplayItem {
    ...
    public List<ItemStack> getDisplayRecipes() {
        ...
        items.add(new CustomItemStack(Material.DIAMOND, "&f使费城充满阳光"));

        items.add(new ItemStack(Material.LILAC));
        items.add(new CustomItemStack(Material.DIAMOND, "&f当老人打鼾时下雨"));

        items.add(new ItemStack(Material.CREEPER_HEAD));
        items.add(new CustomItemStack(Material.DIAMOND, "&f雷雨天"));
